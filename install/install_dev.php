...
// VDip: 48
$sql[]="ALTER TABLE `wD_Games` ADD `blockVotes` set('Draw','Pause','Cancel','Extend','Concede') CHARACTER SET utf8 NOT NULL;";
$sql[]="ALTER TABLE `wD_Backup_Games` ADD `blockVotes` set('Draw','Pause','Cancel','Extend','Concede') CHARACTER SET utf8 NOT NULL;";
...
// VDip: 51
$sql[]="ALTER TABLE `wD_Members` ADD `ccMatch` tinyint(3) unsigned NOT NULL;";
$sql[]="ALTER TABLE `wD_Members` ADD `ipMatch` tinyint(3) unsigned NOT NULL;";
$sql[]="ALTER TABLE `wD_Backup_Members` ADD `ccMatch` tinyint(3) unsigned NOT NULL;";
...
$sql[]="CREATE TABLE IF NOT EXISTS `wD_NMRs` (
...
$sql[]="ALTER TABLE `wD_NMRs` ADD KEY `gameID` (`gameID`,`userID`), ADD KEY `userID` (`userID`);";
