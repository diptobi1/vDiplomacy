<?php
// This is file installs the map data for the ClassicBritain variant
...
$territoryRawData=array(
	array('Clyde', 'Coast', 'Yes', 1, 309, 337, 157, 120),
	array('Edinburgh', 'Coast', 'Yes', 1, 340, 350, 175, 109),
	array('Liverpool', 'Coast', 'Yes', 1, 315, 405, 166, 140),
	array('Yorkshire', 'Coast', 'Yes', 1, 355, 440, 184, 150),
	array('Wales', 'Coast', 'Yes', 1, 305, 480, 154, 179),
