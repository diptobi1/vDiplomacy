...
class RatWarsVariant_panelMemberHome extends panelMemberHome
{
	...
	function memberFinalized()
	{
		...
		return '<span class="member'.$this->id.'StatusIcon"><img src="variants/RatWars/resources/question.png" alt="?" title="Unknown orderstatus" /></span>';
	}
