...
class Fog_Maps extends Maps
{
	...
	function mapHTML($turn)
	{
		...
		return str_replace("map.php?" ,"variants/".$Game->Variant->name."/resources/fogmap.php?verify=".$this->verify."&" , parent::mapHTML($turn));
	}
...
class Classic1898FogVariant_Maps extends Fog_Maps {}
