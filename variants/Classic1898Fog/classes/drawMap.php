...
class Classic1898FogVariant_drawMap extends drawMap {
	...
	protected function resources()
	{
		if ( $this->smallmap )
			$images=array(
				...
				'names'   =>'variants/Classic1898Fog/resources/smallmapNames.png',
				'standoff'=>'images/icons/cross.png');
		else
			$images=array(
				'army'    =>'contrib/army.png',
				'fleet'   =>'contrib/fleet.png',
				'names'   =>'variants/Classic1898Fog/resources/mapNames.png',
				'standoff'=>'images/icons/cross.png');
		
		if ($this->show_all || $this->all_fog) {
			if( $this->smallmap )
				$images['map'] ='variants/Classic1898Fog/resources/smallmap_noFog.png';
			else
				$images['map'] ='variants/Classic1898Fog/resources/map_noFog.png';
		} else {
			if( $this->smallmap )
				$images['map'] ='variants/Classic1898Fog/resources/smallmap.png';
			else
				$images['map'] ='variants/Classic1898Fog/resources/map.png';
		}
		return $images;
	}
