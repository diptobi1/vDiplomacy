...
class Classic1898FogVariant_panelGameBoard extends panelGameBoard
{
	...
	function mapHTML() {
		...
		if (!(file_exists($newFile)))
			$newFile='variants/Classic1898Fog/resources/fogmap.php?&verify='.$verify.'&gameID='.$this->id.'&turn='.$mapTurn;
		$oldMap="map.php?";
		$newMap="variants/Classic1898Fog/resources/fogmap.php?verify=".$verify."&";
	...
	protected function mapJS($mapTurn) {
		...
		libHTML::$footerIncludes[] = '../variants/Classic1898Fog/resources/my_mapUI.js';
	}
