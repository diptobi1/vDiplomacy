...
class Classic1898FogVariant_panelMember extends panelMember
{
	...
	{
		global $User;
		if (($this->userID == $User->id) || ( $User->type['Admin'] && !$this->Game->Members->isJoined() )) return parent::lastLoggedInTxt();
		return '??';
	}	
