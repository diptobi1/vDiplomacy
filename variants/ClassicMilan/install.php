<?php
// This is file installs the map data for the ClassicMilan variant
...
$territoryRawData=array(
	...
	array('Rome', 'Coast', 'Yes', 3, 497, 767, 255, 315),
	array('Milan', 'Land', 'Yes', 3, 488, 684, 246, 280),
	array('Savoy', 'Coast', 'No', 3, 437, 694, 220, 276),
	array('Venetia', 'Coast', 'No', 3, 500, 710, 266, 295),
	array('Greece', 'Coast', 'Yes', 0, 676, 851, 355, 361),
	array('Albania', 'Coast', 'No', 0, 640, 820, 343, 341),
	array('Serbia', 'Land', 'Yes', 0, 669, 766, 357, 324),
	...
	array('Rumania', 'Coast', 'Yes', 0, 770, 717, 412, 272),
	...
	array('Marseilles', 'Coast', 'Yes', 2, 390, 725, 199, 275),
	array('Gascony', 'Coast', 'No', 2, 301, 676, 154, 265),
	array('Barents Sea', 'Sea', 'No', 0, 826, 37, 427, 15),
	array('Norwegian Sea', 'Sea', 'No', 0, 437, 149, 240, 32),
