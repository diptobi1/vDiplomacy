<?php
// This is file installs the map data for the ClassicFlorence variant
...
$territoryRawData=array(
	...
	array('Campania', 'Coast', 'No', 3, 570, 870, 298, 357),
	array('Rome', 'Coast', 'Yes', 3, 522, 800, 272, 330),
	array('Florence', 'Coast', 'Yes', 3, 478, 754, 250, 303),
	array('Piedmont', 'Coast', 'No', 3, 441, 694, 228, 276),
	array('Venetia', 'Coast', 'No', 3, 490, 710, 258, 292),
	array('Taranto', 'Coast', 'Yes', 3, 571, 814, 294, 333),
...
$bordersRawData=array(
	...
	array('Campania','Rome','Yes','Yes'),
	array('Campania','Taranto','Yes','Yes'),
	array('Campania','Tyrrhenian Sea','Yes','No'),
	array('Campania','Ionian Sea','Yes','No'),
	array('Rome','Florence','Yes','Yes'),
	array('Rome','Venetia','No','Yes'),
	array('Rome','Taranto','No','Yes'),
	array('Rome','Tyrrhenian Sea','Yes','No'),
	array('Florence','Piedmont','Yes','Yes'),
	array('Florence','Venetia','No','Yes'),
	array('Florence','Gulf of Lyons','Yes','No'),
	array('Florence','Tyrrhenian Sea','Yes','No'),
	array('Piedmont','Venetia','No','Yes'),
	array('Piedmont','Marseilles','Yes','Yes'),
	array('Piedmont','Gulf of Lyons','Yes','No'),
	array('Piedmont','Tyrolia','No','Yes'),
	array('Venetia','Taranto','Yes','Yes'),
	...
	array('Taranto','Adriatic Sea','Yes','No'),
